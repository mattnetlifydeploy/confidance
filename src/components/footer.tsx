...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-charcoal text-white">
      {/* Decorative elements */}
      <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-teal/5 blur-3xl" />
      <div className="absolute -left-20 bottom-0 h-40 w-40 rounded-full bg-navy/5 blur-3xl" />
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6 flex gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 text-white/40 transition-all hover:bg-teal/20 hover:text-teal"
              >
          ...
          <div>
            ...
            <div className="mt-8">
              <a
                ...
                className="group flex items-center gap-2 text-sm text-white/50 transition-colors hover:text-teal"
              >
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <li>
      <Link
        href={href}
        className="relative text-sm text-white/50 transition-colors hover:text-teal"
      >
        {children}
      </Link>
    </li>
